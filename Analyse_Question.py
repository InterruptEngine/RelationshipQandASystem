...
#         self.question_count_publish_list = [r".*的作品中,有多少本是由.*出版的"]
#         # egg:米米拉的作品中，有多少本是由知识出版社出版的
...
#         self.question_types_num=[self.question_simpleIssue_list,self.question_countBook_list,self.question_same_list,self.question_leader_list,self.question_six_list,self.question_graduate_list,self.question_works_list,self.question_publish_list,self.question_doublecount_list,self.question_count_publish_list]
...
#         if my_index==0 and "character" in types:
#             question_types.append("character_to_simpleIssue")
#         if my_index==1 and "character" in types:
#             question_types.append("character_to_countBook")
#         if my_index==2 and "character" in types:
#             question_types.append("character_to_same")
#         if my_index==3 and "character" in types:
#             question_types.append("character_to_leader")
#         if my_index==4 and "character" in types:
#             question_types.append("character_to_six")
#         if my_index==5 and "character" in types:
#             question_types.append("character_to_graduate")
#         if my_index==6 and "character" in types:
#             question_types.append("character_to_works")
#         if my_index==7 and "character" in types:
#             question_types.append("character_to_publish")
#         if my_index==8 and "character" in types:
#             question_types.append("character_to_doublecount")
#         if my_index==9 and "character" in types:
#             question_types.append("character_to_count_publish")
#
...
class AnalyseQuestion:
    ...
    def analyze_question(self, question):  # 分析问题
        ...
        if question_type == 'question_simpleIssue':
            ...
            node_list = self.find_max(node_list)
            node_list=list(set(node_list))
            my_stop=['人', '演员', '角色','好友','搭档','和音','影','电视','黑龙','江美','首']
            for i in my_stop:
                if i in question:
                    if i in node_list:
                        node_list.remove(i)

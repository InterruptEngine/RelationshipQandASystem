...
当前的结点{          # 将自己新增加的结点写入
'人物','文学作品','文学作品平台'
'人物', '学术会', '联盟', '音乐作品', '学院', '英文名', '文学作品', '出版社', '音乐组合', '公司', '学校', '影视作品', '综艺节目', '学院', '协会', '单位', '学校类别'
...
if __name__ == '__main__':
    ...
    for myInfor in infor:  # 属性可能相同，但属于不同结点
        ...
        elif myInfor[1] in ['义弟', '哥哥', '大舅子', '义父', '伯伯', '父亲', '外祖母', '第一任丈夫', '外孙子', '玄孙', '姑姑', '师姐', '大舅哥', '队友', '外甥女', '小姨子', '堂妹']:
            infor_dict['人物'].add(myInfor[0])
            infor_dict['人物'].add(myInfor[2])
